...
export function Footer(props){
    ...
    if(props.currentPage.includes('search-')) {
        previousPage = currentPageNumber > 1 ? `search-${currentPageNumber - 1}` : '/';
        nextPage = currentPageNumber < 5 ? `search-${currentPageNumber + 1}` : currentPageNumber === 5 ? 'search-6' : '#';
        
        return (
            <footer className="fixed bottom-0 w-full bg-gray-800  py-2 px-6 flex justify-between items-center">
                <a href={previousPage} className="flex-row justify-center py-2 text-white cursor-pointer hover:bg-slate-700 focus:ring-4 focus:outline-none focus:ring-gray-500 font-medium rounded-3xl px-5 text-center inline-flex items-center dark:focus:ring-gray-500 mr-2 hover:shadow-lg transition-all duration-200 ease-in-out hover:scale-110 scale-90 gap-x-2 opacity-90 hover:opacity-100">
                ...
                <a href={nextPage} className="flex-row justify-center py-2 text-white cursor-pointer hover:bg-slate-700 focus:ring-4 focus:outline-none focus:ring-gray-500 font-medium rounded-3xl px-5 text-center inline-flex items-center dark:focus:ring-gray-500 mr-2 hover:shadow-lg transition-all duration-200 ease-in-out hover:scale-110 scale-90 gap-x-2 opacity-90 hover:opacity-100">
